...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="page-wrap">
            ...
            <div class="ps-section--hero">
                <img src="images/hero/01.png" alt=""/>
                <div class="ps-section__content text-center">
                    <h3 class="ps-section__title">OUR BOOK</h3>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="ps-product--cart">
                                                        <img src="<%#Eval("Img") %>" alt=""><a href="product-detail.aspx?id=<%#Eval("Id") %>"><%#Eval("Name") %></a></div>
                                                </td>
                                                ...
                                                <td><span class="total-row">150yuan</span></td>
                                                <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                                    <div class="ps-cart__total">
                                        <p>Total Price: <span id="TotalM">2599yuan</span></p>
                                        <a id="aPay" class="ps-btn ps-btn--sm ps-btn--fullwidth" href="payment.aspx">Process to checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
