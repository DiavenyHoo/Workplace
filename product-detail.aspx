                    ...
                    <div class="ps-product--detail">
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ">
                                <div class="ps-product__image">
                                    <div class="ps-badge"><span id="PPHot" runat="server">25.00yuan</span></div>
                                    <div class="ps-badge ps-badge--new"><span id="PId" runat="server"></span></div>
                                   <a href="video.aspx"><img id="PPImg" runat="server" src="images/cake/img-6.jpg" xq_big="true" setting='{"pwidth":400,"pheight":400,"margin_top":0,"margin_left":0}' /></a> 
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                                <header>
                                    ...
                                    <p class="ps-product__price">
                                        ...
                                        <del id="PPOldprice" runat="server">25.00yuan</del>
                                    </p>
                        ...
                        <div class="tab-content mb-60">
                            ...
                            <div class="tab-pane" role="tabpanel" id="tab_02">
                                <p>1 review for CLASS</p>
                                <p>
                                    Caramels tootsie roll plum. Sweet roll jelly bear claw liquorice. Gingerbread lollipop dragée .
								Pie topping jelly-o. Fruitcake dragée canes tootsie roll. Pastry jelly-o cupcake. Bonbon brownie soufflé muffin.
                                </p>
                                <p>
                                    Sweet roll soufflé oat cake apple pie croissant. Pie gummi bears jujubes  lemon drops gummi bears croissant macaroon
								pie.tootsie rollCarrot cake cake bear claw jujubes topping . Jujubes gummi
            ...
            <section class="ps-section ps-section--best-seller pt-40 pb-100">
                <div class="container">
                    <div class="ps-section__header text-center mb-50">
                        <h4 class="ps-section__top">BOOKS</h4>
