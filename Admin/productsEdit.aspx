...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BigIdeaConn %>" SelectCommand="SELECT [商品ID], [商品名], [现价], [图片], [商品类别], [日期], [销量] FROM [Product]"></asp:SqlDataSource>
